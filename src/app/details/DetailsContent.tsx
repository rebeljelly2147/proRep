  ...
  return (
    <div className="relative z-10 max-w-4xl w-full mx-auto bg-white rounded-3xl shadow-xl p-6 sm:p-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-x-10 sm:gap-y-4 text-sm sm:text-base text-gray-800 mb-8">
        ...
        <div>
          <span className="font-semibold text-blue-700">Department(s):</span> {problem.departments?.join(", ") || "N/A"}
        </div>
        <div>
          <span className="font-semibold text-blue-700">Keywords:</span> {problem.keywords?.join(", ") || "None"}
        </div>
        ...
        <div className="col-span-2">
          ...
          <a href={problem.sourceLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline break-all">
